    ...
    public function checkLimit($limit) {
        ...
        if (substr_count($limit, ',') == 1) {
            ...
            if (!is_numeric($tlimit[0])) {
                $error_limit = true;
            } else if (!is_numeric($tlimit[1])) {
                $error_limit = true;
            }
        } else if (substr_count($limit, ',') == 0) {
